          ...
          <ListItem sx={{ mb: '5px', pl: '5px', pr: '5px' }}>
            <ListItemText sx={{ textAlign: 'center', width: 50 }}>
              <Paper
                ...
                {user.place == 1 && (
                  <EmojiEventsIcon
                    sx={{ color: 'orange', width: 48, height: 48 }}
                  />
                )}
                {user.place == 2 && (
                  <WorkspacePremiumIcon
                    sx={{ color: 'silver', width: 48, height: 48 }}
                  />
                )}
                {user.place == 3 && (
                  <CelebrationIcon
                    sx={{ color: '#cd7f32', width: 48, height: 48 }}
                  />
                )}
                {user.place > 3 && user.place}
              </Paper>
            </ListItemText>
            <ListItemAvatar
              sx={{
              ...
              <Paper
                elevation={1}
                sx={{ borderRadius: 10, width: 64, height: 64 }}>
                <Avatar
                  alt="Remy Sharp"
